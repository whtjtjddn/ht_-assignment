import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, computed, defineComponent, h, isReadonly, isRef, isShallow, isReactive, toRaw, ref, markRaw, useSSRContext, mergeProps, defineAsyncComponent, unref, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from 'vue';
import { h as createHooks, i as getContext, k as hasProtocol, l as joinURL, w as withQuery, s as sanitizeStatusCode, m as isScriptProtocol, c as createError$1, t as toRouteMatcher, n as createRouter, o as defu, p as isEqual, q as stringifyParsedURL, r as stringifyQuery, v as parseQuery, x as destr, y as klona, z as getRequestHeader, A as isEqual$1, B as setCookie, C as getCookie, D as deleteCookie } from '../nitro/nitro.mjs';
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-b7a98a75"]]);
