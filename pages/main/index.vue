...
const tips = ref<string>(
    "# 천안역 가이드\n" +
        ...
        "## 🚉 천안역 정보\n" +
        "\n" +
        "- **위치** : 충청남도 천안시 동남구 만남로 32\n" +
        "- **노선** : 경부선, 수도권 전철 1호선, 장항선\n" +
        "- **운영사** : 코레일\n" +
        "- **특색**  \n" +
        "  - 경부선 KTX, ITX-새마을, 무궁화호 등 다양한 열차 운행  \n" +
        "  - 수도권에서 접근성 좋은 교통 요지  \n" +
        "  - 인근에 버스 터미널, 택시 승강장 등 교통 편리\n" +
        "\n" +
        "---\n" +
        "\n" +
        "## 🎡 천안역 근처 놀거리\n" +
        "\n" +
        "| 장소         | 특징 및 추천 포인트            | 도보/차로 거리 |\n" +
        "| ------------ | ----------------------------- | -------------- |\n" +
        "| **천안아라리오광장** | 젊음의 문화공간, 미술작품 다수, 야외공연 | 도보 3분       |\n" +
        "| **명동거리**  | 옷가게, 카페, 액세서리 쇼핑, 먹거리      | 도보 2분       |\n" +
        "| **천안중앙시장** | 로컬 전통시장, 길거리 음식의 천국       | 도보 8분       |\n" +
        "| **독립기념관**  | 한국 독립운동/역사 체험, 웅장한 조각 공원 | 차로 15분      |\n" +
        "| **각원사**     | 천안 대표 사찰, 벚꽃/단풍 명소           | 차로 10분      |\n" +
        "\n" +
        "---\n" +
        "\n" +
        "## 🍜 천안역 인근 맛집 Best 5\n" +
        ...
        "| 식당명      | 대표메뉴          | 특징                   | 거리      |\n" +
        "| ----------- | ----------------- | ---------------------- | --------- |\n" +
        "| **천안 호두과자 종합판매점** | 호두과자          | 천안 명물, 달달한 디저트        | 역 내부  |\n" +
        "| **천안 원조신부냉면**    | 물냉면, 비빔냉면     | 쫄깃한 면발, 맑은 육수         | 도보 10분|\n" +
        "| **서울깍두기**         | 육개장, 곰탕, 반찬리필 | 24시, 푸짐한 한식           | 도보 5분 |\n" +
        "| **천안삼거리능이버섯갈비탕** | 갈비탕, 능이버섯갈비탕 | 진한 국물, 지역 명물           | 차로 7분 |\n" +
        "| **천안닭강정**         | 닭강정              | 바삭, 달콤, 현지인 추천          | 도보 5분 |\n" +
        "\n" +
        "---\n" +
        "\n" +
        "## ☕ 카페 & 디저트\n" +
        "\n" +
        "- **커피에반하다 천안역점** : 천안역 바로 앞, 아메리카노 저렴, 밝은 분위기  \n" +
        "- **제이제이 베이커리** : 천안역 3분 거리, 빵 맛집, 다양한 신 메뉴  \n" +
        "- **천안 명동카페거리** : 핸드드립/플랫화이트/디저트 전문점 다수 포진\n" +
        "\n" +
        "---\n" +
        "\n" +
        "## 🗺️ 지도 & 꿀팁\n" +
        "\n" +
        "- **네이버/카카오맵**에 ‘천안역’으로 검색하면, 역 중심 먹자골목과 쇼핑코스 한눈에 OK!\n" +
        "- 주말 저녁에는 주변 맛집, 카페, 시장이 붐비니 웨이팅 참고\n" +
        "- 천안 삼거리공원, 천안시립미술관 등 차로 10분 거리에 가볼만한 스팟도 많음\n" +
        "\n" +
        "---\n" +
        "\n" +
        "### 즐거운 천안역 방문 되세요! 😍"
